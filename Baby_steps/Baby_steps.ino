...
#define Enable_potentiometers 1
#define Enable_LCD 0

//Prints values to Serial Monitor 1-Enable 0-Disable
#define Print_Accel_XYZ    0
#define Print_Gyro_XYZ     0
#define Print_KalAngleX    0
#define Print_KalAngleY    0
#define Print_Temperature  0
#define Print_PID_Values   1
#define Print_Motors_Speed 0
#define PRINT_PID_CONSTANTS 1

#define Display_INTRO 0
#define DISPLAY_PID_CONSTANTS 0
...
Adjust_PID_Constants();
#endif


PID_Value = Compute_PID(kalAngleY);  Serial.print("PID Value: "); Serial.print(" "); Serial.print(PID_Value); Serial.print("  ");

//L_Speed = L_Arming + PID_Value;
//R_Speed = R_Arming + PID_Value;

if(PID_Value > 0)
{
  backward(PID_Value,PID_Value);
}

if(PID_Value < 0)
{
  PID_Value = -PID_Value;
  forward(PID_Value,PID_Value);
}
...
/*else
{
  ...
  /* Print Data */
#if Print_Accel_XYZ // Set to 1 to activate
 ...
 #if Print_KalAngleX //Set 1 to activate
 ...
 #endif
  //Serial.print("   ");
#if Print_KalAngleY //Set 1 to activate
...
#if Print_Temperature // Set to 1 to print the temperature
  Serial.print("   ");
